...
import com.mayalogy.mayu.text.dtrees.DependencyTreeNavigator.TypedDependencyRole;
...
public class TestTDNavigator extends TestCase {
	...
	public void testGetCoordinate() {
		...
		for(TreeGraphNode t:tdn.getCoordinate(new TDCoordinate("nsubj", com.mayalogy.mayu.text.dtrees.TDCoordinate.TDRole.GOVERNOR))) {
